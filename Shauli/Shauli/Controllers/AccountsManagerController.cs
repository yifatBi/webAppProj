...
namespace Shauli.Controllers
{
    public class AccountsManagerController : Controller
    {
        ...
        // GET: AccountsManager/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AccountsManager/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,Usr,Password,ConfirmPassword,Email,Address,City,Country,IsAdmin")] Account account)
        {
